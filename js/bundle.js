...
function forms(formSelector, modalTimerID) {
  ...
  function showThanksModal(message) {
    ...
    setTimeout(() => {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_0__.closeModalDialog)('.modal');
    }, 4000);
  }
...
/* harmony export */   "closeModalDialog": function() { return /* binding */ closeModalDialog; },
...
function closeModalDialog(modalSelector) {
  const modal = document.querySelector(modalSelector);
...
function modal(triggerSelector, modalSelector, modalTimerID) {
  ...
  modal.addEventListener('click', e => {
    if (e.target === modal || e.target.getAttribute('data-close') == '') {
      closeModalDialog(modalSelector);
    }
  });
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-02-09');
});
}();
/******/ })()
;
